...
**问：** 打开评论和截图显示以下内容  
<img src="../../图片/BC截图和评论/webview2报错.webp" width="60%" height="60%" />
...
<img src="../../图片/BC截图和评论/webview2-下载.webp" width="60%" height="60%" />
<img src="../../图片/BC截图和评论/webview2-下载-2.webp" width="60%" height="60%" />

**问：** 我已经安装了WebView2\我无需安装 评论、截图显示为一片空白
也没有任何提示或报错  

<img src="../../图片/BC截图和评论/评论-空白.webp" width="60%" height="60%" />
<img src="../../图片/BC截图和评论/截图-空白.webp" width="60%" height="60%" />
...
<img src="../../图片/BC截图和评论/右键菜单.webp" width="60%" height="60%" />
...
先通过系统自带的查询功能进行查询IP  
同时按下 **win和R键** 弹出运行  
<img src="../../图片/BC截图和评论/运行.webp" width="60%" height="60%" />

输入 **cmd** 点确定 弹出命令提示符 窗口  
<img src="../../图片/BC截图和评论/命令提示符.webp" width="60%" height="60%" />
...
输入域名 并查询  
<img src="../../图片/BC截图和评论/在线查询1.webp" width="60%" height="60%" />

查看结果  
<img src="../../图片/BC截图和评论/在线查询2.webp" width="60%" height="60%" />
...
搜索“记事本”，右键，以管理员身份运行  
<img src="../../图片/BC截图和评论/打开记事本.webp" width="60%" height="60%" />

点击【文件→打开】  
<img src="../../图片/BC截图和评论/文件过滤器.webp" width="60%" height="60%" />
...
<img src="../../图片/BC截图和评论/DNS1.webp" width="60%" height="60%" />
<img src="../../图片/BC截图和评论/DNS2.webp" width="60%" height="60%" />
<img src="../../图片/BC截图和评论/DNS3.webp" width="60%" height="60%" />
...
**答：** 可以在彗星内设置代理服务器  
<img src="../../图片/BC截图和评论/BC代理设置.webp" width="60%" height="60%" />
