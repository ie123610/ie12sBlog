...
**答：** 请打开 [专家模式](./BC专家模式及其作用.md) 并查看统计中 展开 内存使用 选项 以查看是什么占用了内存  
<img src="../../图片/BC内存占用过高/内存详情.webp" width="60%" title="内存使用明细" height="60%" />
...
<img src="../../图片/BC内存占用过高/限制种子市场.webp" width="60%" title="限制他人共享数量" height="60%" />
...
<img src="../../图片/BC内存占用过高/运行-系统属性.webp" width="60%" height="60%" />

高级》性能 点击设置按钮  
<img src="../../图片/BC内存占用过高/系统属性1.webp" width="60%" height="60%" />

高级》虚拟内存 点击更改按钮  
<img src="../../图片/BC内存占用过高/系统属性2.webp" width="60%" height="60%" />

取消勾选 自动管理分页文件大小  
选择C盘 设置为无分页文件  
<img src="../../图片/BC内存占用过高/C盘无分页文件.webp" width="60%" title="迁移虚拟内存" height="60%" />
...
<img src="../../图片/BC内存占用过高/无分页文件警告.webp" width="60%" height="60%" />

选择其他分区并设置虚拟内存 **一定要选择使用固态硬盘的分区**  
<img src="../../图片/BC内存占用过高/选择其他分区.webp" width="60%" height="60%" />
...
<img src="../../图片/BC内存占用过高/UDP队列大小.webp" width="60%" height="60%" />
...
**针对移动硬盘也是相同的道理**  
<img src="../../图片/BC内存占用过高/下载后移动文件.webp" title="完成后移动文件" width="60%" height="60%" />
...
一般来说在内存足够的情况下缓存越大越好  
<img src="../../图片/BC内存占用过高/磁盘缓存.webp" title="磁盘缓存设置" width="60%" height="60%" />
