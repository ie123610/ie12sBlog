# 比特彗星常见问题-反吸血 设置IP过滤和客户端过滤 WIP

在之前的教程中我们已经介绍了  
如何配置比特彗星中 基于流量的自动反吸血  
以及通过peeID和客户端名称来屏蔽吸血客户端  

[比特彗星常见问题-屏蔽吸血客户端和设置自动反吸血](./BC反吸血.md)
...
<img src="../../图片/BC反吸血2/ip过滤器.jpg" width="60%" height="60%" />
...
其他非永久封禁则不会 在计时结束后会自动取消封禁  

<img src="../../图片/BC反吸血2/菜单-ip过滤器.jpg" width="60%" height="60%" />
...
<img src="../../图片/BC反吸血2/客户端过滤-手动.jpg" width="60%" height="60%" />
<img src="../../图片/BC反吸血2/客户端过滤-订阅.jpg" width="60%" height="60%" />

### 客户端列表

客户端列表功能从之前 BT下载 选项中移到了 新增加的客户端过滤选项内  
可以识别更多种类的客户端  

<img src="../../图片/BC反吸血2/客户端列表.jpg" />
...
客户端过滤与IP过滤类似有手动列表和订阅列表之分  

两个列表都有一个兜底规则  
也就是决定 那些没有被规则匹配到客户端是阻止还是允许  
...
<img src="../../图片/BC反吸血2/客户端过滤-添加.jpg" />
