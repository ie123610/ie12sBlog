...
在设置STUN穿透期间请不要开启任何形式的代理其极有可能影响到STUN穿透 
...
以及自由度更高的 miniUPnP 客户端这其实是由于BT下载的特殊性所导致的
...
使得即使在已经优化过网络结构且运营商NAT是全锥型的情况下
依然无法穿透 表现为 穿透日志一直再刷新
 启动 停止 "stun XXXX error" 穿透通道失效 等的报错信息
"stun pubile addr check error"
