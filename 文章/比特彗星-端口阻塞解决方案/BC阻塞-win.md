...
win+R 键 弹出 **运行** 
输入 `cmd` 点确定 打开命令提示符  
<img src="../../图片/BC阻塞-win/运行-cmd.webp" width="60%" height="60%" />
...
<img src="../../图片/BC阻塞-win/IPv6-链路本地.webp" width="60%" height="60%" title="本地链接 IPv6 地址" />


当然也可以直接到 网络适配器选项 里去查看 
win+R 弹出运行 输入 `ncpa.cpl` 点击 确定  
<img src="../../图片/BC阻塞-win/运行-网络连接.webp" width="60%" height="60%" />

弹出 **网络连接** 窗口  
选择 正在使用的网卡 **右键** 选择 **属性**  
<img src="../../图片/BC阻塞-win/网卡-属性.webp" width="60%" height="60%" />

查看 Internet协议版本 6 （TCP/IPv6） 是否勾选上  
将 IPv6协议 勾选上 后点击确定 即可  
<img src="../../图片/BC阻塞-win/网卡-勾选IPv6.webp" width="60%" height="60%" />
...
<img src="../../图片/BC阻塞-win/运行-注册表.webp" width="60%" height="60%" />
...
```
<img src="../../图片/BC阻塞-win/注册表-路径.webp" width="60%" height="60%" />

找到 **DisabledComponents** 右键 修改  
如果没有这一项 则需要手动创建 或者直接用后文中的命令  
<img src="../../图片/BC阻塞-win/注册表-修改.webp" width="60%" height="60%" />

选择 **十进制** 值 填写 **32** 填写完成后点确定  
**重启计算机后生效**  
<img src="../../图片/BC阻塞-win/注册表-保存.webp" width="60%" height="60%" />
...
<img src="../../图片/BC阻塞-win/测试-v4优先.webp" width="60%" height="60%" />
...
<img src="../../图片/BC阻塞-win/网卡-v6-属性.webp" width="60%" height="60%" />

选择 **使用下面的DNS服务器地址**  
<img src="../../图片/BC阻塞-win/网卡-v6-dns.webp" width="60%" height="60%" />
...
<img src="../../图片/BC阻塞-win/测试-大数据包传输失败.webp" width="60%" height="60%" />
<img src="../../图片/BC阻塞-win/测试-大数据包传输失败-2.webp" width="60%" height="60%" />
