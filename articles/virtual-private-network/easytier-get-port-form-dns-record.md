...
此方法在VNT上已经通过TXT记录实现：[教程](../lucky-STUN/stun-VNT-networkin.md)  
...
无需再向过去那样进行繁琐的配置  
使用lucky更新 TXT记录的具体方法:[教程](../lucky-STUN/lucky-ddns-2.15.md)  
...
无需再向过去那样进行繁琐的配置  
使用lucky更新 SRV记录的具体方法：[教程](../lucky-STUN/lucky-ddns-2.15.md)  
