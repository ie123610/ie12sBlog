...
**示意图**  
<img src="../../images/gost-bt-穿透/gost-bt-穿透_gost穿透流程图.jpg" width="60%" height="60%" />
...
<img src="../../images/gost-bt-穿透/下载sysctl.jpg" width="60%" height="60%" />
<img src="../../images/gost-bt-穿透/编辑sysctl.jpg" width="60%" height="60%" />
...
<img src="../../images/gost-bt-穿透/nano-sysctl.jpg" width="60%" height="60%" />

使用 `sysctl –p` 重载文件使配置生效 此命令无输出  
输入 `sysctl net.ipv4.ip_forward`以检查值  
<img src="../../images/gost-bt-穿透/sysctl-检查值.jpg" width="60%" height="60%" />
...
默认只列出 filter 表  
<img src="../../images/gost-bt-穿透/检查iptable规则-1.jpg" width="60%" height="60%" />


而 DNAT 是在 nat 表里面的  
需要使用 `iptables -t nat -vL`  
<img src="../../images/gost-bt-穿透/检查iptable规则-2.jpg" width="60%" height="60%" />
...
查看 CPU 架构 输入 `lscpu`  
<img src="../../images/gost-bt-穿透/查看架构.jpg" width="60%" height="60%" />
...
<img src="../../images/gost-bt-穿透/下载gost.jpg" width="60%" height="60%" />

**查看目录下文件**
切换目录 `cd /usr/local/bin/`
列出目录下载的文件 `ls -l`  

<img src="../../images/gost-bt-穿透/下载文件位置.jpg" width="60%" height="60%" />
...
<img src="../../images/gost-bt-穿透/gost-命令解析.jpg" width="60%" height="60%" />
...
<img src="../../images/gost-bt-穿透/Linux-注册服务信息.jpg" width="60%" height="60%" />
...
检查服务状态 和 服务日志内容  
<img src="../../images/gost-bt-穿透/gost-服务信息.jpg" width="60%" height="60%" />
...
<img src="../../images/gost-bt-穿透/gost-win_x64.jpg" width="60%" height="60%" />
...
通过浏览网页来测试代理是否可以接通  
<img src="../../images/gost-bt-穿透/火狐代理设置.jpg" width="60%" height="60%" />
...
<img src="../../images/gost-bt-穿透/网站-ip检测.jpg" width="60%" height="60%" />
...
<img src="../../images/gost-bt-穿透/添加路由表.jpg" width="60%" height="60%" />
...
<img src="../../images/gost-bt-穿透/检查路由表-1.jpg" width="60%" height="60%" />
<img src="../../images/gost-bt-穿透/检查路由表-2.jpg" width="60%" height="60%" />
...
<img src="../../images/gost-bt-穿透/ping.jpg" width="60%" height="60%" />
...
<img src="../../images/gost-bt-穿透/监听端口.jpg" width="60%" height="60%" />
...
<img src="../../images/gost-bt-穿透/bc-代理设置.jpg" width="60%" height="60%" />


点击右下角的黄灯选择重新检查端口 重新检查后 应变成绿灯  
且显示的外网IP应该会变成 Linux服务器的IP 由于使用了代理 内网IP无法检测会显示为空  

<img src="../../images/gost-bt-穿透/绿灯.jpg" width="60%" height="60%" />
<img src="../../images/gost-bt-穿透/绿灯-2.jpg" width="60%" height="60%" />

下载任意热门种子 例如 [乌班图镜像](../bitcomet-FAQ/BC下载测速.md)  
查看 **用户选项卡** 中的发起列 若看不到发起列 则需要右键表头弹出菜单勾选发起  
**若有远程发起 且传入用户的IP显示正常 则穿透功能已经实现**  

<img src="../../images/gost-bt-穿透/远程传入用户.jpg" width="60%" height="60%" />
...
<img src="../../images/gost-bt-穿透/注册的服务.jpg" width="60%" height="60%" />

命令：`net start 任务id`  
注意这里使用的是任务id而非任务的显示名称  
<img src="../../images/gost-bt-穿透/命令-启动服务.jpg" width="60%" height="60%" />
