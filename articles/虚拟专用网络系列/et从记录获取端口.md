...
**STUN规则**  
<img src="../../images/et从记录获取端口/et从记录获取端口-stun规则.jpg" width="60%" height="60%" />

**设置TXT记录更新**  
<img src="../../images/et从记录获取端口/et从记录获取端口-txt记录更新设置.jpg" width="60%" height="60%" />

**检视更新效果**  
<img src="../../images/et从记录获取端口/et从记录获取端口-txt记录更新效果.jpg" width="60%" height="60%" />

**连接测试**  
<img src="../../images/et从记录获取端口/et从记录获取端口-txt连接效果1.jpg" width="60%" height="60%" />

**连接成功**  
<img src="../../images/et从记录获取端口/et从记录获取端口-txt连接效果2.jpg" width="60%" height="60%" />
...
**设置SRV记录更新**  
<img src="../../images/et从记录获取端口/et从记录获取端口-srv记录更新设置.jpg" width="60%" height="60%" />

**检视更新效果**  
<img src="../../images/et从记录获取端口/et从记录获取端口-srv记录更新效果.jpg" width="60%" height="60%" />

**解析效果**  
<img src="../../images/et从记录获取端口/et从记录获取端口-srv记录解析效果.jpg" width="60%" height="60%" />

**连接测试**  
<img src="../../images/et从记录获取端口/et从记录获取端口-srv连接效果1.jpg" width="60%" height="60%" />

**连接成功**  
<img src="../../images/et从记录获取端口/et从记录获取端口-srv连接效果2.jpg" width="60%" height="60%" />
...
**示例**  
<img src="../../images/et从记录获取端口/et从记录获取端口-http200-1.jpg" width="60%" height="60%" />
<img src="../../images/et从记录获取端口/et从记录获取端口-http200-2.jpg" width="60%" height="60%" />
<img src="../../images/et从记录获取端口/et从记录获取端口-http200-3.jpg" width="60%" height="60%" />
<img src="../../images/et从记录获取端口/et从记录获取端口-http200-4.jpg" width="60%" height="60%" />
<img src="../../images/et从记录获取端口/et从记录获取端口-http200-5.jpg" width="60%" height="60%" />
...
**第一种重定向格式效果演示**  
<img src="../../images/et从记录获取端口/et从记录获取端口-重定向url-1.jpg" width="60%" height="60%" />
<img src="../../images/et从记录获取端口/et从记录获取端口-重定向url-2.jpg" width="60%" height="60%" />
<img src="../../images/et从记录获取端口/et从记录获取端口-重定向url-3.jpg" width="60%" height="60%" />


**第二种重定向格式效果显示**  
<img src="../../images/et从记录获取端口/et从记录获取端口-重定向-查询-1.jpg" width="60%" height="60%" />
<img src="../../images/et从记录获取端口/et从记录获取端口-重定向-查询-2.jpg" width="60%" height="60%" />
<img src="../../images/et从记录获取端口/et从记录获取端口-重定向-查询-3.jpg" width="60%" height="60%" />
