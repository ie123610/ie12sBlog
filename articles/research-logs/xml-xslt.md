...
效果展示：  
<img loading="lazy" src="../../images/xml-xslt/myrss-1.png" width="60%" />
...
如果不需要XML中的某些元素及内容 那在写xsl文件的时候就不设置对应的匹配规则  
...
效果展示：  
<img loading="lazy" src="../../images/xml-xslt/myrss-2.png" width="60%" />
