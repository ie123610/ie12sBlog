...
随着战地新作的推出如战地2042 战地6 等 EA为其添加了 新的EA 反作弊程序  
...
大部分情况下其都能看到报错还比较好对症去解决  
最怕的就是什么都没有 不声不响的 但这个情况就给我遇到了  
更新了 反作弊程序后我的战地1就没法打开了  
...
其主要部分是代码 115 错误 但是搜索这个115错误代码  
基本都是让你从新安装或者更新反作弊程序  
ea的反作弊帮助页面没有记录此问题 [链接](https://help.ea.com/zh/articles/platforms/pc-ea-anticheat/)  

但是 反复重新安装反作弊程序后也没有效果  
而且如果是 缺少反作弊程序的话 这个是有弹窗提示的  

现在的情况 是反作弊程序在启动时发生错误  
之后一直重试并继续发生错误 且没有弹窗提示  

从应该reddit的帖子推断出 115 的含义应该是 "EA AntiCheat has detected an unacceptable configuration"  
即 “EA反作弊系统检测到不可接受的配置” 不过这个帖子里面 没有提供截图 不确定是否是弹窗错误  
不过考虑到这个提示信息其应该是一个 弹窗错误 而非事件查看器中的错误 [链接](https://www.reddit.com/r/battlefield_one/comments/1gukf8h/error_115/?show=original)  
...
在b站和知乎的两个帖子中提到了 可以尝试在游戏启动期间断网  
从评论来看似乎有一定的效果 [b站专栏](https://www.bilibili.com/opus/1145889547931877382) [知乎帖子](https://zhuanlan.zhihu.com/p/1994512224904041141)

在b站的这篇专栏的评论区有人留言提到 “开着加速器就能通过，开梯子也不行，什么鬼原理”  
看起来这似乎和系统代理有关 再结合之前看到的AI生成的 一般性的提示 包括关闭代理和虚拟专用网络程序  

清除代理这项操作还没有尝试过 我也确实在使用Windows代理  
再一次抱着试一试的心态 清除Windows代理后  
