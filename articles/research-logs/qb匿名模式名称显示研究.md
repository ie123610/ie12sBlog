...
**qbittorrent 客户端信息**  
<img src="../../images/qb匿名模式名称显示研究/qb匿名模式研究_qb版本信息.jpg" width="60%" height="60%" />

**比特彗星 客户端信息**  
<img src="../../images/qb匿名模式名称显示研究/qb匿名模式研究_bc版本信息.jpg" width="60%" height="60%" />

### qbittorrent 开启匿名模式
<img src="../../images/qb匿名模式名称显示研究/qb匿名模式研究_qb开启匿名模式.jpg" width="60%" height="60%" />

两客户端同时下载相同的测试资源  
观察两客户端的用户栏信息  

**比特彗星**  
<img src="../../images/qb匿名模式名称显示研究/qb匿名模式研究_bc查看qb客户端名称.jpg" width="60%" height="60%" />

**qbittorrent**  
<img src="../../images/qb匿名模式名称显示研究/qb匿名模式研究_qb查看bc客户端名称.jpg" width="60%" height="60%" />

观察比特彗星中对端 qbittorrent 的客户端名称  
qbittorrent 被正确识别  

<img src="../../images/qb匿名模式名称显示研究/qb匿名模式研究_qb客户端名称和peerID-1.jpg" width="60%" height="60%" />
...
<img src="../../images/qb匿名模式名称显示研究/qb匿名模式研究_qb文档信息.jpg" width="60%" height="60%" />
