---
title: 端口阻塞解决方案-2.2 可用的解决方法 （光猫部分）
sidebar_label: 2.2 可用的解决方法 （光猫部分）
---
...
<img loading="lazy" src="../../images/bitcomet-port-forwarding-modem-settings/china-telecom-classic-login-interface-1.webp" width="60%" title="经典界面样式1 图片来自网络" />

<img loading="lazy" src="../../images/bitcomet-port-forwarding-modem-settings/china-telecom-classic-login-interface-2.webp" width="60%" title="经典界面样式2 图片来自网络" />

<img loading="lazy" src="../../images/bitcomet-port-forwarding-modem-settings/china-telecom-tianyi-gateway-login-interface.webp" width="60%" title="天翼网关页面中的 快速装维入口 图片来自网络" />
...
<img loading="lazy" src="../../images/bitcomet-port-forwarding-modem-settings/china-unicom-standard-login-interface.webp" width="60%" />
<img loading="lazy" src="../../images/bitcomet-port-forwarding-modem-settings/china-unicom-admin-login-interface.webp" width="60%" />
...
<img loading="lazy" src="../../images/bitcomet-port-forwarding-modem-settings/china-telecom-enable-ipv6.webp" width="60%" />
...
<img loading="lazy" src="../../images/bitcomet-port-forwarding-modem-settings/china-unicom-enable-ipv6.webp" title="联通" width="60%" />
<img loading="lazy" src="../../images/bitcomet-port-forwarding-modem-settings/china-mobile-enable-ipv6.webp" title="移动" width="60%" />
...
<img loading="lazy" src="../../images/bitcomet-port-forwarding-modem-settings/select-element.webp" width="60%" />

控制台的中代码，会定位到选中组件的位置 如图红色方框的 "disabled"  
这里双击一下 进入编辑状态 **将其改成"enabled"** 输入完以后回车一下即可  
各种被禁用的 按钮、单/复选框、组合框 **一般都可以通过这种方式解锁**  

<img loading="lazy" src="../../images/bitcomet-port-forwarding-modem-settings/unlock-element.webp" width="60%" />
...
<img loading="lazy" src="../../images/bitcomet-port-forwarding-modem-settings/china-telecom-ipv6-firewall-1.webp" width="60%" />
<img loading="lazy" src="../../images/bitcomet-port-forwarding-modem-settings/china-unicom-ipv6-firewall.webp" width="60%" />
<img loading="lazy" src="../../images/bitcomet-port-forwarding-modem-settings/china-mobile-ipv6-firewall.webp" width="60%" />
<img loading="lazy" src="../../images/bitcomet-port-forwarding-modem-settings/china-telecom-ipv6-firewall-2.webp" width="60%" />
...
<img loading="lazy" src="../../images/bitcomet-port-forwarding-modem-settings/bridge-mode-china-telecom.webp" width="60%" title="电信常见样式" />
<img loading="lazy" src="../../images/bitcomet-port-forwarding-modem-settings/bridge-mode-china-unicom.webp" width="60%" title="联通常见样式" />
<img loading="lazy" src="../../images/bitcomet-port-forwarding-modem-settings/bridge-mode-china-mobile.webp" width="60%" title="移动常见样式" />
...
<img loading="lazy" src="../../images/bitcomet-port-forwarding-modem-settings/example-bridge-mode-1.webp" width="60%" title="移动常见样式" />
...
<img loading="lazy" src="../../images/bitcomet-port-forwarding-modem-settings/example-bridge-mode-2.webp" width="60%" />
