...
[端口转发 DMZ 以及 UPnP 的作用和原理](./07-port-forwarding-DMZ-and-UPnP.md)  
...
<img src="../../images/bitcomet-port-forwarding-router-settings/modem-upnp-mobile.webp" width="60%" height="60%" title="UPnP功能" />

### 设置DMZ 和虚拟服务器（光猫）

应用>高级NAT设置>DMZ设置/虚拟服务器设置  
<img src="../../images/bitcomet-port-forwarding-router-settings/modem-port-forwarding-telecom.webp" width="60%" height="60%" title="虚拟服务器即端口转发" />

<img src="../../images/bitcomet-port-forwarding-router-settings/modem-port-forwarding-telecom.webp" width="60%" height="60%" title="DMZ" />
<img src="../../images/bitcomet-port-forwarding-router-settings/modem-dmz-modem.webp" width="60%" height="60%" title="DMZ" />
...
<img src="../../images/bitcomet-port-forwarding-router-settings/run-network-connections-window.webp" width="60%" height="60%" />

弹出 **网络连接** 窗口  
选择 正在使用的网卡 **右键** 选择 **状态**  
<img src="../../images/bitcomet-port-forwarding-router-settings/network-adapter-status.webp" width="60%" height="60%" />

点开 **详细信息**  
<img src="../../images/bitcomet-port-forwarding-router-settings/network-adapter-details.webp" width="60%" height="60%" />
...
<img src="../../images/bitcomet-port-forwarding-router-settings/network-adapter-details-content.webp" width="60%" height="60%" />

点击 关闭 回到 **网络连接** 窗口  
再次右键网卡 选择 **属性**  
<img src="../../images/bitcomet-port-forwarding-router-settings/network-adapter-properties.webp" width="60%" height="60%" />


**Internet协议版本4**（TCP/IPv4）点击 **属性**  
选择 **使用下面的IP地址** 和 **使用下面的DNS服务器地址**  

<img src="../../images/bitcomet-port-forwarding-router-settings/network-adapter-ipv4-protocol.webp" width="60%" height="60%" />
<img src="../../images/bitcomet-port-forwarding-router-settings/network-adapter-static-ip-1.webp" width="60%" height="60%" />
...
<img src="../../images/bitcomet-port-forwarding-router-settings/network-adapter-static-ip-2.webp" width="60%" height="60%" title="修改完成后的状态" />
...
**答：** 还记得在 [1.4路由器交换机和光猫的作用](./05-switches-and-routers.md) 中所讲的内容吗？  
