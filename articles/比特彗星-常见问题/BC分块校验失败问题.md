...
<img src="../../images/BC分块校验失败问题/BC分块校验失败问题-1.jpg" width="60%" height="60%" />
...
<img src="../../images/BC分块校验失败问题/BC分块校验失败问题-2.jpg" width="60%" height="60%" />

**答：** 到 高级设置中 搜索 **分块**  
将 `bittorrent.separate_sources_for_failed_piece` 设置为 **是**  

<img src="../../images/BC分块校验失败问题/BC分块校验失败问题-3.jpg" width="60%" height="60%" />
