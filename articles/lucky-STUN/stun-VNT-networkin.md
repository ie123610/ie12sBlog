...
**示意图**  
<img loading="lazy" src="../../images/stun-VNT-networkin/process-diagram.webp" width="60%" height="60%" />
...
**示例**  
<img loading="lazy" src="../../images/stun-VNT-networkin/download-vtns.webp" width="60%" height="60%" />

解压后得到下列文件  
建议重命名一下文件夹 减少嵌套的文件夹层数  
让文件路径变的短一些 这会方便之后的设置  

<img loading="lazy" src="../../images/stun-VNT-networkin/vtns-file.webp" width="60%" height="60%" />
...
**示例**  
<img loading="lazy" src="../../images/stun-VNT-networkin/vtns-available-commands.webp" width="60%" height="60%" />
...
<img loading="lazy" src="../../images/stun-VNT-networkin/vtns-service-1.webp" width="60%" height="60%" />
<img loading="lazy" src="../../images/stun-VNT-networkin/vtns-service-2.webp" width="60%" height="60%" />
...
<img loading="lazy" src="../../images/stun-VNT-networkin/vnt-file.webp" width="60%" height="60%" />


#### 设置基础组网信息

运行 vnt_app.exe 点击右上角的加号 添加组网配置  
<img loading="lazy" src="../../images/stun-VNT-networkin/vnt-add-configuration-file.webp" width="60%" height="60%" />
...
**示例**  
<img loading="lazy" src="../../images/stun-VNT-networkin/vnt-configuration-file-1.webp" width="60%" height="60%" />
...
**示例**  
<img loading="lazy" src="../../images/stun-VNT-networkin/vnt-configuration-file-2.webp" width="60%" height="60%" />
...
**示例**  
<img loading="lazy" src="../../images/stun-VNT-networkin/vnt-configuration-file-3.webp" width="60%" height="60%" />
...
**示例**  
<img loading="lazy" src="../../images/stun-VNT-networkin/vnt-configuration-file-4.webp" width="60%" height="60%" />
...
**示例**  
<img loading="lazy" src="../../images/stun-VNT-networkin/vnt-update-txt-record-1.webp" width="60%" height="60%" />
<img loading="lazy" src="../../images/stun-VNT-networkin/vnt-update-txt-record-2.webp" width="60%" height="60%" />
...
**示例**  
<img loading="lazy" src="../../images/stun-VNT-networkin/vnt-android-client-example.webp" width="60%" height="60%" />
...
<img loading="lazy" src="../../images/stun-VNT-networkin/client-connection-effect-1.webp" width="60%" height="60%" />
<img loading="lazy" src="../../images/stun-VNT-networkin/client-connection-effect-2.webp" width="60%" height="60%" />

#### 访问虚拟局域网

<img loading="lazy" src="../../images/stun-VNT-networkin/access-virtual-lan.webp" width="60%" height="60%" />

#### 访问物理局域网

<img loading="lazy" src="../../images/stun-VNT-networkin/access-physical-lan.webp" width="60%" height="60%" />
