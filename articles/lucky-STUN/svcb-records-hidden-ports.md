...
其有些类似于Windows中的嵌套窗口  
<img loading="lazy" src="../../images/svcb-records-hidden-ports/windows-nested-window.webp" width="60%" />

当然地址栏的变化并没有消失  
其只是从浏览器的地址栏中转移到了iframe框架的地址栏中  
<img loading="lazy" src="../../images/svcb-records-hidden-ports/iframe-example.webp" width="60%" />
...
**示例**  
<img loading="lazy" src="../../images/svcb-records-hidden-ports/traditional-records.webp" width="60%" />
...
**示例**  
<img loading="lazy" src="../../images/svcb-records-hidden-ports/https-record.webp" width="60%" />
...
<img loading="lazy" src="../../images/svcb-records-hidden-ports/query-result.webp" width="60%" />
<img loading="lazy" src="../../images/svcb-records-hidden-ports/query-result-2.webp" width="60%" />
...
<img loading="lazy" src="../../images/svcb-records-hidden-ports/firefox-settings-1.webp" width="60%" />
...
**示例**  
<img loading="lazy" src="../../images/svcb-records-hidden-ports/firefox-settings-2.webp" width="60%" />
...
<img loading="lazy" src="../../images/svcb-records-hidden-ports/ech-test-1.webp" width="60%" />
<img loading="lazy" src="../../images/svcb-records-hidden-ports/ech-test-2.webp" width="60%" />


(其实在F12里面看DNS解析这一项就行了)  
<img loading="lazy" src="../../images/svcb-records-hidden-ports/dns-request-method.webp" width="60%" />
...
<img loading="lazy" src="../../images/svcb-records-hidden-ports/firefox-manual-proxy.webp" width="60%" />
...
<img loading="lazy" src="../../images/svcb-records-hidden-ports/example-web-service.webp" width="60%" />
...
<img loading="lazy" src="../../images/svcb-records-hidden-ports/port-access.webp" width="60%" />
...
<img loading="lazy" src="../../images/svcb-records-hidden-ports/no-port-access.webp" width="60%" />
...
<img loading="lazy" src="../../images/svcb-records-hidden-ports/update-https-record-1.webp" width="60%" />
<img loading="lazy" src="../../images/svcb-records-hidden-ports/update-https-record-2.webp" width="60%" />
...
<img loading="lazy" src="../../images/svcb-records-hidden-ports/android-secure-dns-1.webp" width="60%" />
<img loading="lazy" src="../../images/svcb-records-hidden-ports/android-secure-dns-2.webp" width="60%" />
<img loading="lazy" src="../../images/svcb-records-hidden-ports/android-secure-dns-3.webp" width="60%" />
<img loading="lazy" src="../../images/svcb-records-hidden-ports/android-secure-dns-4.webp" width="60%" />

**示例**  
<img loading="lazy" src="../../images/svcb-records-hidden-ports/firefox-android-https-record.webp" width="60%" />
