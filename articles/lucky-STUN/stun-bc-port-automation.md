...
**检查软件版本号**  
<img src="../../images/stun-bc-port-automation/stun-bc端口自动化-检查版本1.jpg" width="60%" height="60%" />
<img src="../../images/stun-bc-port-automation/stun-bc端口自动化-检查版本2.jpg" width="60%" height="60%" />
...
<img src="../../images/stun-bc-port-automation/stun-bc端口自动化-设置远程访问1.jpg" width="60%" height="60%" />
<img src="../../images/stun-bc-port-automation/stun-bc端口自动化-设置远程访问2.jpg" width="60%" height="60%" />

先登录到旧版  再通过下方的链接跳转到新版WebUI  

<img src="../../images/stun-bc-port-automation/stun-bc端口自动化-登录远程访问1.jpg" width="60%" height="60%" />
<img src="../../images/stun-bc-port-automation/stun-bc端口自动化-登录远程访问2.jpg" width="60%" height="60%" />

显示出新版 WebUI 后需要再次登录  

<img src="../../images/stun-bc-port-automation/stun-bc端口自动化-登录远程访问3.jpg" width="60%" height="60%" />
<img src="../../images/stun-bc-port-automation/stun-bc端口自动化-登录远程访问4.jpg" width="60%" height="60%" />
...
<img src="../../images/stun-bc-port-automation/stun-bc端口自动化-获取令牌.jpg" width="60%" height="60%" />
...
**示例**  
<img src="../../images/stun-bc-port-automation/stun-bc端口自动化-脚本示例.jpg" width="60%" height="60%" />
...
<img src="../../images/stun-bc-port-automation/stun-bc端口自动化-测试效果.jpg" width="60%" height="60%" />
<img src="../../images/stun-bc-port-automation/stun-bc端口自动化-测试效果2.jpg" width="60%" height="60%" />
...
<img src="../../images/stun-bc-port-automation/stun-bc端口自动化-填写脚本.jpg" width="60%" height="60%" />

若设置都正确则STUN规则在穿透成功后  
其会自动的修改BC的监听端口 BC也会在右下角弹出通知  

**检视STUN穿透日志**  
<img src="../../images/stun-bc-port-automation/stun-bc端口自动化-最终输出效果.jpg" width="60%" height="60%" />
