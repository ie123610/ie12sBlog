...
* **租用低性能VPS+frp穿透 在个人电脑上开服**  
  ...
  缺点：即使是低性能服务器依然要些花钱（主要是带宽） 
  如果VPS离开玩家和mc服务端较远延迟可能还是较高毕竟比直接部署在VPS上要多绕一些路径  
...
3. 在stun传穿透的IP或者端口发生变化时可以触发webhook请求
  使用其向dynv6的更新api发送请求更新srv记录中的端口  
...
[链接](https://blog.azurezeng.com/recaptcha-use-in-china/)  
...
<img src="../../images/stun-mc-srv/MyZones-More.webp" width="60%" height="60%" />

再点击右侧的 Create new Zone  

<img src="../../images/stun-mc-srv/Create-new-Zone.webp" width="60%" height="60%" />
...
<img src="../../images/stun-mc-srv/create-ddns-domain.webp" width="60%" height="60%" />

创建完成后会自动切换到该域名的配置页面  
选择 **Records** 选项卡  
添加 记录类型选择 **SRV**  

<img src="../../images/stun-mc-srv/add-srv-record.webp" width="60%" height="60%" />

填写 Name Server Port 这几个选项（后面会解释为什么这样填）  

<img src="../../images/stun-mc-srv/fill-srv-content.webp" width="60%" height="60%" />
...
**配置效果**  
<img src="../../images/stun-mc-srv/srv-fill-effect.webp" width="60%" height="60%" />
...
<img src="../../images/stun-mc-srv/srv-query-effect.webp" width="60%" height="60%" />
...
<img src="../../images/stun-mc-srv/hide-ip.webp" width="60%" height="60%" />

而且实际使用的地址是 `_minecraft._tcp.mc.ie12test.dynv6.net` 中srv记录里指定的地址
直接解析这个地址也是解析不出来IP的  
因为DNS解析一般默认解析的都是 A（IPv4地址）和AAAA（IPv6地址）记录  

<img src="../../images/stun-mc-srv/hide-ip-2.webp" width="60%" height="60%" />
...
<img src="../../images/stun-mc-srv/keys.webp" width="60%" height="60%" />
...
<img src="../../images/stun-mc-srv/HTTP_Tokens.webp" width="60%" height="60%" />
...
<img src="../../images/stun-mc-srv/scheduled-task.webp" width="60%" height="60%" />
...
<img src="../../images/stun-mc-srv/task-get-id.webp" title="设置效果" width="60%" height="60%" />


点击手动触发  
<img src="../../images/stun-mc-srv/manual-trigger-task.webp" width="60%" height="60%" />

查看日志中输出的信息  
如果配置正确会 **返回域名和ID**  
这里的ID就是域名ID即zoneID 有了这个我们才能获取记录ID  

<img src="../../images/stun-mc-srv/returned-zone-id.webp" width="60%" height="60%" />
...
<img src="../../images/stun-mc-srv/returned-record-id.webp" width="60%" height="60%" />
...
<img src="../../images/stun-mc-srv/test-update-srv-record-response.webp" title="配置效果" width="60%" height="60%" />
...
<img src="../../images/stun-mc-srv/test-update-srv-record-response.webp" width="60%" height="60%" />
...
<img src="../../images/stun-mc-srv/add-ddns.webp" width="60%" height="60%" />
...
<img src="../../images/stun-mc-srv/ddns-configuration.webp" width="60%" height="60%" />


**配置效果**  
等待片刻后显示 **公网IP未改变** 或 **更新成功** 即设置正确  

<img src="../../images/stun-mc-srv/ddns-effect.webp" width="60%" height="60%" />
...
<img src="../../images/stun-mc-srv/add-stun.webp" />
<img src="../../images/stun-mc-srv/add-stun-2.webp" width="60%" height="60%" />
...
<img src="../../images/stun-mc-srv/stun-rule-configuration.webp" width="60%" height="60%" />
...
<img src="../../images/stun-mc-srv/stun-rule-webhook.webp" width="60%" height="60%" />

填写完成后点击 **右上角的手动触发** 查看是否调用成功  
**成功** 会返回记录的详细信息 注意这里的端口号变成了 **6666** 
保存规则

<img src="../../images/stun-mc-srv/webhook-prompt.webp" width="60%" height="60%" />
<img src="../../images/stun-mc-srv/stun-rule-webhook-response.webp" width="60%" height="60%" />


**最终效果**  
<img src="../../images/stun-mc-srv/stun-rule-final-effect.webp" width="60%" height="60%" />
...
使用 [自定义局域网联机](https://www.mcmod.cn/class/2754.html)（Lan Server Properties） mod固定端口  

值得注意的是在1.16.5下有一个bug  
离线登录玩家无法进行多人游戏即多人游戏按钮被禁用 加个[Mod](https://www.mcmod.cn/class/10643.html)即可修复  


<img src="../../images/stun-mc-srv/mc-create-server.webp" title="对局域网开放" width="60%" height="60%" />
<img src="../../images/stun-mc-srv/mc-add-server.webp" title="填写地址" width="60%" height="60%" />
<img src="../../images/stun-mc-srv/mc-server-status.webp" title="服务器已正常显示" width="60%" height="60%" />
<img src="../../images/stun-mc-srv/mc-login-success.webp" title="登录成功" width="60%" height="60%" />
