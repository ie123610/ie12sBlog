...
<img loading="lazy" src="../../images/email-notification-port/netease-enable-smtp.webp" width="60%" height="60%" />
...
<img loading="lazy" src="../../images/email-notification-port/scheduled-task-1.webp" width="60%" height="60%" />
<img loading="lazy" src="../../images/email-notification-port/scheduled-task-2.webp" width="60%" height="60%" />

关闭规则开关 我们只使用手动触发  

<img loading="lazy" src="../../images/email-notification-port/scheduled-task-3.webp" width="60%" height="60%" />
...
<img loading="lazy" src="../../images/email-notification-port/batch-processing-example.webp" width="60%" height="60%" />


创建完成后我们先在命令提示符中进行测试  
**传参顺序》端口号-规则名称-授权码**  

<img loading="lazy" src="../../images/email-notification-port/test-script-1.webp" width="60%" height="60%" />
<img loading="lazy" src="../../images/email-notification-port/test-script-2.webp" width="60%" height="60%" />
<img loading="lazy" src="../../images/email-notification-port/test-email-1.webp" width="60%" height="60%" />
...
<img loading="lazy" src="../../images/email-notification-port/test-script-in-lucky-1.webp" width="60%" height="60%" />
<img loading="lazy" src="../../images/email-notification-port/test-script-in-lucky-2.webp" width="60%" height="60%" />
...
<img loading="lazy" src="../../images/email-notification-port/linux-script-1.webp" width="60%" height="60%" />
...
<img loading="lazy" src="../../images/email-notification-port/linux-script-2.webp" width="60%" height="60%" />
...
<img loading="lazy" src="../../images/email-notification-port/test-email-2.webp" width="60%" height="60%" />
<img loading="lazy" src="../../images/email-notification-port/test-script-in-lucky-3.webp" width="60%" height="60%" />
...
<img loading="lazy" src="../../images/email-notification-port/test-script-in-lucky-4.webp" width="60%" height="60%" />
<img loading="lazy" src="../../images/email-notification-port/test-email-3.webp" title="邮件效果" width="60%" height="60%" />
...
<img loading="lazy" src="../../images/email-notification-port/solution-1.webp" title="方法1" width="60%" height="60%" />
<img loading="lazy" src="../../images/email-notification-port/solution-2.webp" title="方法2" width="60%" height="60%" />
