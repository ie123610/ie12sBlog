...
不过这可能会有误伤  
<img src="../../images/BC-anti-leech/client-list.webp" width="60%" height="60%" />
...
<img src="../../images/BC-anti-leech/xunlei-extreme-edition.webp" title="迅雷极速版" width="60%" height="60%" />

**问：** 那该如何屏蔽这些吸血客户端，同时防止误伤呢？  

**答：** 在高级设置中 屏蔽 ID XL0018 以及15000 和 15001 端口  

<img src="../../images/BC-anti-leech/block-id.webp" title="屏蔽 ID XL0018" width="60%" height="60%" />
<img src="../../images/BC-anti-leech/block-port.webp" title="屏蔽 15000 和 15001 端口" width="60%" height="60%" />

**效果：**  
<img src="../../images/BC-anti-leech/blocked-xunlei.webp" title="被屏蔽的迅雷客户端" width="60%" height="60%" />

**问：** 如果还有其他的吸血客户端 该如何进行屏蔽呢？  

**答：** 手动添加ID 需要填写实际ID  
将鼠标放在 **客户端名** 上 可查看实际客户端ID  
<img src="../../images/BC-anti-leech/client-id.webp" width="60%" height="60%" />
...
**示例**  
<img src="../../images/BC-anti-leech/client-name-blocking.webp" width="60%" height="60%" />

每个客户端名称之间使用 **英文逗号** 分开   
端口号和ID屏蔽也是如此  

**效果**  
<img src="../../images/BC-anti-leech/client-name-blocking-effect.webp" width="60%" height="60%" />
...
<img src="../../images/BC-anti-leech/file-centipede-disguise-settings.webp" title="文件蜈蚣中的客户端ID设置" width="60%" height="60%" />
...
**即设置》bt下载 中的反吸血保护设置**  
<img src="../../images/BC-anti-leech/anti-leech-automatic.webp" width="60%" height="60%" />
...
<img src="../../images/BC-anti-leech/connection-status-icon.webp" width="60%" height="60%" />
