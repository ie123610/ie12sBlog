...
<img loading="lazy" src="../../images/BC-OOM/memory-details.webp" width="60%" title="内存使用明细" height="60%" />
...
<img loading="lazy" src="../../images/BC-OOM/limit-torrent-marketplace.webp" width="60%" title="限制他人共享数量" height="60%" />
...
<img loading="lazy" src="../../images/BC-OOM/run-system-properties.webp" width="60%" height="60%" />

高级》性能 点击设置按钮  
<img loading="lazy" src="../../images/BC-OOM/system-properties-1.webp" width="60%" height="60%" />

高级》虚拟内存 点击更改按钮  
<img loading="lazy" src="../../images/BC-OOM/system-properties-2.webp" width="60%" height="60%" />

取消勾选 自动管理分页文件大小  
选择C盘 设置为无分页文件  
<img loading="lazy" src="../../images/BC-OOM/c-drive-no-pagefile.webp" width="60%" title="迁移虚拟内存" height="60%" />
...
<img loading="lazy" src="../../images/BC-OOM/no-pagefile-warning.webp" width="60%" height="60%" />

选择其他分区并设置虚拟内存 **一定要选择使用固态硬盘的分区**  
<img loading="lazy" src="../../images/BC-OOM/select-other-partition.webp" width="60%" height="60%" />
...
<img loading="lazy" src="../../images/BC-OOM/udp-queue-size.webp" width="60%" height="60%" />
...
**针对移动硬盘也是相同的道理**  
<img loading="lazy" src="../../images/BC-OOM/move-files-after-download.webp" title="完成后移动文件" width="60%" height="60%" />
...
一般来说在内存足够的情况下缓存越大越好  
<img loading="lazy" src="../../images/BC-OOM/disk-cache.webp" title="磁盘缓存设置" width="60%" height="60%" />
