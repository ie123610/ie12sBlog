...
<img loading="lazy" src="../../images/BC-reseed-99/enable-unfinished-suffix.jpg" width="60%" />

添加需要补档的种子 启动任务后马上停止  
只需让BT客户端创建目录和未完成的临时文件即可  
因为开启了 与预先分配磁盘空间 所以临时文件有完整的大小  

<img loading="lazy" src="../../images/BC-reseed-99/generated-temporary-files.jpg" width="60%" />

删除这些临时文件 将通过其他方式下载到的  
其对应文件复制到目录下  

<img loading="lazy" src="../../images/BC-reseed-99/import-complete-file.jpg" width="60%" />

回到客户端 选择任务右键弹出菜单 选择重新检查完整性  
进度应到达100% 可以开始上传  

<img loading="lazy" src="../../images/BC-reseed-99/progress-restored.jpg" width="60%" />

当然有些时候 无用文件所占用的空间可能较大  
或者单纯是不希望无用文件存在于磁盘上 也可以将其清理掉  
方法也很简单 紧刚才的步骤 在任务进入上传后 取消勾选那些无用文件  

<img loading="lazy" src="../../images/BC-reseed-99/clean-up-unused-files.jpg" width="60%" />

再次打开文件下载目录 会发现被取消的文件还在  
而且还多出来了 个`.piece_part.bc!`文件  

<img loading="lazy" src="../../images/BC-reseed-99/part-files.jpg" width="60%" />
