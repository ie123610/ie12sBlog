...
**示例**  
<img loading="lazy" src="../../images/BC-port-forwarding-FAQ/ipv4-and-ipv6-ports.jpg" width="60%" />
...
根据网络情况进行分析和排查 **端口阻塞解决方案：**[链接](../../the-index.md#比特彗星-端口阻塞解决方案)  
...
* **下载缓慢和无法下载问题[重置]：** [链接](./BC-download-speed-issues-2.md)  
