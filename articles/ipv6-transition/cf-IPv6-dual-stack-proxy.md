...
不过需要注意光猫和路由器上的防火墙  
IPv6教程开放端口教程：[链接](../../the-index.md#比特彗星-端口阻塞解决方案)  
...
* **使用STUN 穿透获得IPv4访问性**  
  ...
  **此方案在之前的教程中已经有所讲解:** [链接](../lucky-STUN/stun-web-serve-CF.md)  
...
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/flowchart.JPG" width="60%" />
...
* [在Windows下使用lucky更新动态域名](../lucky-STUN/lucky-ddns.md)  
* [在Windows下使用lucky配置反向代理以实现较为安全的WEB访问](../lucky-STUN/lucky-web.md)  
...
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/dns-resolution-demo.JPG" width="60%" />
...
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/resolution-to-cf-effect-preview.JPG" width="60%" />
...
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/origin-rules-0.JPG" width="60%" />
...
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/origin-rules-1.JPG" width="60%" />


接下来设置 **回源端口** 也就是CF节点连接你的的源服务器使用的目标端口  
填写源服务器实际监听的IPv6端口 这里使用36100作为演示  

<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/origin-rules-2.JPG" width="60%" />
...
例如之前的教程中所设置的lucky反向代理 [链接](../lucky-STUN/lucky-web.md)  
此时CF节点和源服务器之间将使用TLS加密  

<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/tls-encryption-mode-selection.JPG" width="60%" />
...
但如果像之前的教程中那样使用lucky设置了反向代理和TLS证书  [链接](../lucky-STUN/lucky-web.md)  
...
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/effect-preview-0.JPG" width="60%" />
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/effect-preview-1.JPG" width="60%" />
...
**示例**  
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/cf-520-error.JPG" width="60%" />
...
**示例**  
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/cf-ssl-handshake-error.JPG" width="60%" />
...
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/cf-ip-selection-0.JPG" width="60%" />
...
**示例**  
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/windows-ip-selection-result.JPG" width="60%" />
...
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/cf-ip-selection-android.JPG" width="60%" />
...
更加可行的方法是使用一个**运行在本地虚拟专用网络** 来捕获设备发出的DNS请求  
...
**软件界面**   
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/vhost-preview-1.JPG" width="60%" />
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/vhost-preview-0.JPG" width="60%" />
...
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/vhost-set-hosts-file.JPG" width="60%" />

设置完成后打开 开关 建立一个虚拟专用网络连接 DNS“劫持”即可生效  


**示例**

<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/vhost-run-0.JPG" width="60%" />
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/vhost-run-1.JPG" width="60%" />


**检视效果**

<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/vhost-inspect-result.JPG" width="60%" />
