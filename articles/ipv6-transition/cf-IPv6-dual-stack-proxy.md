...
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/flowchart.JPG" width="60%" height="60%" />
...
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/dns-resolution-demo.JPG" width="60%" height="60%" />
...
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/resolution-to-cf-effect-preview.JPG" width="60%" height="60%" />
...
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/origin-rules-0.JPG" width="60%" height="60%" />
...
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/origin-rules-1.JPG" width="60%" height="60%" />


接下来设置 **回源端口** 也就是CF节点连接你的的源服务器使用的目标端口  
填写源服务器实际监听的IPv6端口 这里使用36100作为演示  

<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/origin-rules-2.JPG" width="60%" height="60%" />
...
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/tls-encryption-mode-selection.JPG" width="60%" height="60%" />
...
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/effect-preview-0.JPG" width="60%" height="60%" />
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/effect-preview-1.JPG" width="60%" height="60%" />
...
**示例**  
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/cf-520-error.JPG" width="60%" height="60%" />
...
**示例**  
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/cf-ssl-handshake-error.JPG" width="60%" height="60%" />
...
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/cf-ip-selection-0.JPG" width="60%" height="60%" />
...
**示例**  
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/windows-ip-selection-result.JPG" width="60%" height="60%" />
...
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/cf-ip-selection-android.JPG" width="60%" height="60%" />
...
**软件界面**   
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/vhost-preview-1.JPG" width="60%" height="60%" />
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/vhost-preview-0.JPG" width="60%" height="60%" />
...
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/vhost-set-hosts-file.JPG" width="60%" height="60%" />
...
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/vhost-run-0.JPG" width="60%" height="60%" />
<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/vhost-run-1.JPG" width="60%" height="60%" />


**检视效果**

<img loading="lazy" src="../../images/cf-IPv6-dual-stack-proxy/vhost-inspect-result.JPG" width="60%" height="60%" />
